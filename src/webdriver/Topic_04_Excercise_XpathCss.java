...
public class Topic_04_Excercise_XpathCss {
	WebDriver driver;
	...
	public void TC_02_Invalid_Email() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("Hoa Tran");
		driver.findElement(By.id("txtEmail")).sendKeys("invalid@123.");
		driver.findElement(By.id("txtCEmail")).sendKeys("invalid@123");
		driver.findElement(By.id("txtPassword")).sendKeys("Abc123");
		driver.findElement(By.id("txtCPassword")).sendKeys("Abc123");
		driver.findElement(By.id("txtPhone")).sendKeys("0905123321");
		driver.findElement(By.xpath("//div[@class='form frmRegister']//button[text()='ĐĂNG KÝ']")).click();
	...
	public void TC_03_Incorrect_Email() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("Hoa Tran");
		driver.findElement(By.id("txtEmail")).sendKeys("valid@gmail.com");
		driver.findElement(By.id("txtCEmail")).sendKeys("invalid@gmail.com");
		driver.findElement(By.id("txtPassword")).sendKeys("Abc123");
		driver.findElement(By.id("txtCPassword")).sendKeys("Abc123");
		driver.findElement(By.id("txtPhone")).sendKeys("0905123321");
		driver.findElement(By.xpath("//div[@class='form frmRegister']//button[text()='ĐĂNG KÝ']")).click();
	...
	public void TC_04_Invalid_Password() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("Hoa Tran");
		driver.findElement(By.id("txtEmail")).sendKeys("valid@gmail.com");
		driver.findElement(By.id("txtCEmail")).sendKeys("valid@gmail.com");
